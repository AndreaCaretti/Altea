...
```json
{
    ...
    "area": {
	    ...
	    "asset": {        
            "guid": "32ddbafb-27f4-4d19-ab5d-ddfcc5979f07"
        }
    },
    "handlingUnits": [
...
| -------------------- | --------------------------------------------------------------------------------------- | -------- | -------------------------------------- |
| guid                 | UUID generato dalla piattaforma, identifica univocamente la notifica                    | UUID     | "ada49efe-c732-4ed3-a7a9-cb7275ae5c5e" |
...
| asset                | asset IoT che ha generato l'allarme                                                     | Object   |                                        |
| - guid               | UUID asset IoT che ha generato l'allarme                                                | UUID     | "32ddbafb-27f4-4d19-ab5d-ddfcc5979f07" |
